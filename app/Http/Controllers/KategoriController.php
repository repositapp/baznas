...
class KategoriController extends Controller
{
    public function index()
    {
        ...
        return view('pengaturan.kategori-artikel.index', compact('kategoris', 'search'));
    }

    public function create()
    {
        return view('pengaturan.kategori-artikel.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pengaturan.kategori-artikel.edit', compact('kategori'));
    }

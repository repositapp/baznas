    ...
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                @endif
                <form class="form-horizontal" action="{{ route('penyaluran.update', $penyaluran->id) }}" method="POST"
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group date">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('tgl_penyaluran', $tanggalFormatted) }}" placeholder="dd/mm/yyyy">
                                    </div>
                                    ...
                                    <select class="form-control select2 @error('mustahik_id') is-invalid @enderror"
                                        ...
                                        @foreach ($mustahiks as $mustahik)
                                            <option value="{{ $mustahik->id }}"
                                                @if (old('mustahik_id', $penyaluran->mustahik_id) == $mustahik->id) selected="selected" @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="anggota_keluarga" name="anggota_keluarga"
                                        placeholder="Jumlah Anggota Keluarga" value="{{ $keluarga }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="1" name="alamat_rumah" id="alamat_rumah" placeholder="Alamat Rumah ...">{{ $alamat }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <select class="form-control select2 @error('zakat_id') is-invalid @enderror"
                                        ...
                                        @foreach ($zakats as $zakat)
                                            <option value="{{ $zakat->id }}"
                                                @if (old('zakat_id', $penyaluran->zakat_id) == $zakat->id) selected="selected" @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="metode_bayar" name="metode_bayar"
                                        placeholder="Metode Pembayaran" value="{{ $metode }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control @error('total') is-invalid @enderror"
                                        id="total" name="total" value="{{ old('total', $penyaluran->total) }}"
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="sisa_saldo" name="sisa_saldo"
                                        placeholder="Sisa Saldo" value="{{ $formattedSisa }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @enderror
                                    @if ($penyaluran->gambar)
                                        <img src="{{ asset('storage/' . $penyaluran->gambar->gambar) }}"
                                            class="img-fluid mb-3 col-sm-3 d-block" alt="Gambar Penyaluran">
                                    @else

        ...
        <div class="box box-success">
            ...
            <div class="box-body no-padding">
                <table class="table table-bordered table-striped table-hover" id="pembayaranTable">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="6" class="text-center">Silakan pilih filter untuk menampilkan data.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
@push('script')
    <script>
        ...
        function loadData(page = 1) {
            ...
            $.ajax({
                url: "{{ route('pelaporan.pembayaran.data') }}",
                data: {
                    tgl_awal,
                    tgl_akhir,
                    zakat_id,
                ...
                success: function(response) {
                    ...
                    if (data.length > 0) {
                        ...
                        rows =
                            '<tr><td colspan="6" class="text-center">Data Pembayaran Zakat belum Tersedia.</td></tr>';
                        $('#btnCetak').hide();
                    }
        ...
        $('#btnCetak').on('click', function() {
            ...
            let url =
                `{{ route('pelaporan.pembayaran.cetak') }}?tgl_awal=${tgl_awal}&tgl_akhir=${tgl_akhir}&zakat_id=${zakat_id}`;

...
<body onload="window.print()">
    ...
    <h3 style="text-align: center;">Laporan Penyaluran Zakat</h3>
    <p style="text-align: center; margin-block-start: -1em;">Periode:
        {{ date('d/m/Y', strtotime(request('tgl_awal'))) }} s/d
        ...
        <tbody>
            @forelse ($data as $key => $item)
                <tr>
                    ...
                    <td>{{ date('d/m/Y', strtotime($item->tgl_penyaluran)) }}</td>

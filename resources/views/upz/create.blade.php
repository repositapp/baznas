...
@section('content')
    ...
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('upz.store') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="kategoriupz_id" class="col-sm-3 control-label">Kategori UPZ</label>

                        <div class="col-sm-9">
                            <select class="form-control @error('kategoriupz_id') is-invalid @enderror" id="kategoriupz_ids"
                                name="kategoriupz_id">
                                <option value="" hidden>-- Choose --</option>
                                @foreach ($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}"
                                        @if (old('kategoriupz_id') == $kategori->id) selected="selected" @endif>
                                        {{ $kategori->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        <label for="nama_upz" class="col-sm-3 control-label">Nama UPZ</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('nama_upz') is-invalid @enderror"
                                id="nama_upz" name="nama_upz" value="{{ old('nama_upz') }}" placeholder="Nama UPZ">
                            @error('nama_upz')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        <label for="text" class="col-sm-3 control-label">NPWP</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('npwp') is-invalid @enderror" id="npwp"
                                name="npwp" value="{{ old('npwp') }}" placeholder="NPWP UPZ">
                            @error('npwp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        <label for="no_pengukuhan" class="col-sm-3 control-label">Nomor Pengukuhan</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('no_pengukuhan') is-invalid @enderror"
                                id="no_pengukuhan" name="no_pengukuhan" value="{{ old('no_pengukuhan') }}"
                    ...
                    <div class="form-group">
                        <label for="tgl_pengukuhan" class="col-sm-3 control-label">Tanggal Pengukuhan</label>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('tgl_pengukuhan', \Carbon\Carbon::parse(now())->translatedFormat('m/d/Y')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon"
                                name="telepon" value="{{ old('telepon') }}" placeholder="Nomor Telepon">
                            @error('telepon')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('fax') is-invalid @enderror" id="fax"
                                name="fax" value="{{ old('fax') }}" placeholder="Nomor Fax">
                            @error('fax')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                id="email" name="email" value="{{ old('email') }}" placeholder="Alamat Email">
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

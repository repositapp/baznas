            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('program.update', $program->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" value="{{ old('title', $program->title) }}" placeholder="Nama Program">
                            @error('title')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('range_start', $datestartFormatted) }}" placeholder="dd/mm/yyyy">
                            </div>
                            @error('range_start')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    name="range_end" value="{{ old('range_end', $dateendFormatted) }}"
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('jumlah_donasi') is-invalid @enderror"
                                    id="jumlah_donasi" name="jumlah_donasi"
                                    value="{{ old('jumlah_donasi', $program->jumlah_donasi) }}" placeholder="Jumlah Donasi">
                            </div>
                            @error('jumlah_donasi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-sm-10">
                            ...
                            @if ($program->image)
                                <img src="{{ asset('storage/' . $program->image) }}"
                                    class="img-fluid mb-3 col-sm-3 d-block" alt="Banner">
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="tinymce  @error('body') is-invalid @enderror" rows="10" name="body" id="body">{{ old('body', $program->body) }}</textarea>
                            @error('body')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('status') is-invalid @enderror" id="status"
                                ...
                                <option value="0" @if (old('status', $program->status) == '0') selected="selected" @endif>
                                    Tidak Aktif
                                </option>
                                <option value="1" @if (old('status', $program->status) == '1') selected="selected" @endif>
                                    Pengumpulan
                                </option>
                                <option value="2" @if (old('status', $program->status) == '2') selected="selected" @endif>
                                    Selesai
                                </option>
                            </select>
                            @error('status')

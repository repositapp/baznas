...
@section('content')
    ...
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('bansos-penyaluran.update', $penyaluran->id) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                            ...
                            <select class="form-control select2 @error('bansos_id') is-invalid @enderror" id="bansos_id"
                                ...
                                @foreach ($programs as $program)
                                    <option value="{{ $program->id }}"
                                        @if (old('bansos_id', $penyaluran->bansos_id) == $program->id) selected="selected" @endif> {{ $program->title }}
                                    </option>
                                @endforeach
                            </select>
                            @error('bansos_id')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" value="{{ old('title', $penyaluran->title) }}" placeholder="Nama Penyaluran">
                            @error('title')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('jumlah_penerima') is-invalid @enderror"
                                ...
                                value="{{ old('jumlah_penerima', $penyaluran->jumlah_penerima) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('total_nominal') is-invalid @enderror"
                                ...
                                value="{{ old('total_nominal', $penyaluran->total_nominal) }}" placeholder="Total">
                            @error('total_nominal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="tinymce  @error('body') is-invalid @enderror" rows="10" name="body" id="body">{{ old('body', $penyaluran->body) }}</textarea>
                            @error('body')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

...
@section('content')
    ...
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('zakat.update', $zakat->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('nama_sumbangan') is-invalid @enderror"
                                id="nama_sumbangan" name="nama_sumbangan"
                                value="{{ old('nama_sumbangan', $zakat->nama_sumbangan) }}" placeholder="Nama Sumbangan">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('jenis_benda') is-invalid @enderror"
                                id="jenis_benda" name="jenis_benda" value="{{ old('jenis_benda', $zakat->jenis_benda) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('nilai_ukuran') is-invalid @enderror"
                                id="nilai_ukuran" name="nilai_ukuran"
                                value="{{ old('nilai_ukuran', $zakat->nilai_ukuran) }}" placeholder="Nilai/Ukuran">
                            @error('nilai_ukuran')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

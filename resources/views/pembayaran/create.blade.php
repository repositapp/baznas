                                ...
                                <div class="col-sm-9">
                                    <div class="input-group date">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('tgl_bayar', \Carbon\Carbon::parse(now())->translatedFormat('m/d/Y')) }}"
                                    ...
                                    <select class="form-control select2 @error('muzaki_id') is-invalid @enderror"
                                        ...
                                        @foreach ($muzakis as $muzaki)
                                            <option value="{{ $muzaki->id }}"
                                                @if (old('muzaki_id') == $muzaki->id) selected="selected" @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        id="jenis_pembayaran" name="jenis_pembayaran" value="{{ old('jenis_pembayaran') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('nilai_ukur') is-invalid @enderror"
                                        id="nilai_ukur" name="nilai_ukur" value="{{ old('nilai_ukur') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        id="jumlah_keluarga" name="jumlah_keluarga" value="{{ old('jumlah_keluarga') }}"

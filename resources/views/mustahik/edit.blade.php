...
@section('content')
    ...
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('mustahik.update', $mustahik->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    <select class="form-control select2 @error('golongan_id') is-invalid @enderror"
                                        ...
                                        @foreach ($golongans as $golongan)
                                            <option value="{{ $golongan->id }}"
                                                @if (old('golongan_id', $mustahik->golongan_id) == $golongan->id) selected="selected" @endif>
                                                {{ $golongan->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" value="{{ old('nama', $mustahik->nama) }}"
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                        ...
                                        <option value="Laki-Laki"
                                            @if (old('jenis_kelamin', $mustahik->jenis_kelamin) == 'Laki-Laki') selected="selected" @endif>
                                            Laki-Laki
                                        </option>
                                        <option value="Perempuan"
                                            @if (old('jenis_kelamin', $mustahik->jenis_kelamin) == 'Perempuan') selected="selected" @endif>
                                            Perempuan
                                        </option>
                                    </select>
                                    @error('jenis_kelamin')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                        ...
                                        value="{{ old('pekerjaan', $mustahik->pekerjaan) }}" placeholder="Pekerjaan">
                                    @error('pekerjaan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control  @error('keterangan') is-invalid @enderror" rows="3" name="keterangan"
                                        id="keterangan" placeholder="Keterangan ...">{{ old('keterangan', $mustahik->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control  @error('alamat_rumah') is-invalid @enderror" rows="1" name="alamat_rumah"
                                        id="alamat_rumah" placeholder="Alamat Rumah ...">{{ old('alamat_rumah', $mustahik->alamat_rumah) }}</textarea>
                                    @error('alamat_rumah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('telepon') is-invalid @enderror"
                                        id="telepon" name="telepon" value="{{ old('telepon', $mustahik->telepon) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email', $mustahik->email) }}"
